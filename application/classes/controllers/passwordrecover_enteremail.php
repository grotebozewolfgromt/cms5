...
class passwordrecover_enteremail extends TPasswordRecoverEnterEmailControllerAbstract
{
    ...
    {
        return APP_PATH_CMS_TEMPLATES.DIRECTORY_SEPARATOR.'tpl_passwordrecover_enteremail.php';
    }
