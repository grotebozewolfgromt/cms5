...
//			}
	...
	{
		// return array_key_exists($sFieldName, $this->arrFieldInfo); ==>original
		return isset($this->arrFieldInfo[$sFieldName]); //changed from array_key_exists => isset on 17-10-2025
	}
