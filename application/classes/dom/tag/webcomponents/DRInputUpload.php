...
class DRInputUpload extends FormInputAbstract
{
	...
	private function resizeImageGD(&$arrJSONResponse, &$sMimeType, &$sUploadPath)
	{
		...
		//==== RESIZE IMAGE		
		$objImgMax = 		$this->imagescaleGD($objImgOrg, APP_ADMIN_IMAGE_RESIZE_MAX_WIDTHPX, APP_ADMIN_IMAGE_RESIZE_MAX_HEIGHTPX, $arrJSONResponse[DRInputUpload::JSONAK_RESPONSE_IMAGE_MAX_WIDTH], $arrJSONResponse[DRInputUpload::JSONAK_RESPONSE_IMAGE_MAX_HEIGHT]);
		$objImgLarge = 		$this->imagescaleGD($objImgOrg, APP_ADMIN_IMAGE_RESIZE_LARGE_WIDTHPX, APP_ADMIN_IMAGE_RESIZE_LARGE_HEIGHTPX, $arrJSONResponse[DRInputUpload::JSONAK_RESPONSE_IMAGE_LARGE_WIDTH], $arrJSONResponse[DRInputUpload::JSONAK_RESPONSE_IMAGE_LARGE_HEIGHT]);
		$objImgMedium = 	$this->imagescaleGD($objImgOrg, APP_ADMIN_IMAGE_RESIZE_MEDIUM_WIDTHPX, APP_ADMIN_IMAGE_RESIZE_MEDIUM_HEIGHTPX, $arrJSONResponse[DRInputUpload::JSONAK_RESPONSE_IMAGE_MEDIUM_WIDTH], $arrJSONResponse[DRInputUpload::JSONAK_RESPONSE_IMAGE_MEDIUM_HEIGHT]);
		$objImgThumbnail = 	$this->imagescaleGD($objImgOrg, APP_ADMIN_IMAGE_RESIZE_THUMBNAIL_WIDTHPX, APP_ADMIN_IMAGE_RESIZE_THUMBNAIL_HEIGHTPX, $arrJSONResponse[DRInputUpload::JSONAK_RESPONSE_IMAGE_THUMBNAIL_WIDTH], $arrJSONResponse[DRInputUpload::JSONAK_RESPONSE_IMAGE_THUMBNAIL_HEIGHT]);
