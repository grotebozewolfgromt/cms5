...
/**
 * Description of TMime
 *
 * Helper class for Mime types.
 * This class does not represent a mime type.
 * mime classes are TMimeMessage en TMimePart
 * 
 * 4 dec 2014: TMime: line length aangepast
 * 
 * inspired by Zend Mime
 * 
 * 28 oct 2020 - types deleted because they are now defined in typedef lib
 * 
 * @author drenirie
 */
class TMime
{
    ...
    const LINELENGTH = 70; //72, maar just to be safe ivm \r\n
    const LINEEND = "\n";
     ...
     * @param string $sEOL Defaults to {@link LINEEND}
     * @access public
     * @return string
     */
    public static function getBoundaryLine($sBoundary, $sEOL = self::LINEEND)
    {
        return $sEOL . '--' . $sBoundary . $sEOL;
    }
     ...
     * @return string
     */
    public static function getMimeEnd($sBoundary, $EOL = self::LINEEND)
    {
        return $EOL . '--' . $sBoundary . '--' . $EOL;
    }    
}
