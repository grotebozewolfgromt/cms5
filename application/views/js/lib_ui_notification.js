 ...
 * 
 * how to use:
 * new Notify('my title', 'my description', 'info'); //info, success, warning, error, notify
 * 
 ...
 * @param sDescription string language aware text to display
 * @param sType string type of notification: 'info', 'success', 'warning', 'error', 'notify'
 * 
 */
function sendNotification(sTitle, sDescription, sType)
{
    new Notify(sTitle, sDescription, sType);
}
...
class Notify{
    ...
    configureNotifyPosition(){
        ...
        if(opt.hAlign === 'left') {
            wrapper.classList.add('hLeftNotification');
            wrapper.classList.remove('hRightNotifiction');
        }
        else{
            wrapper.classList.add('hRightNotifiction');
            wrapper.classList.remove('hLeftNotification');
        }

        if(opt.vAlign === 'bottom'){
            wrapper.classList.add('vBottomNotification');
            wrapper.classList.remove('vTopNotifiction');
        }
        else{
            wrapper.classList.add('vTopNotifiction');
            wrapper.classList.remove('vBottomNotification');
        }
    }
