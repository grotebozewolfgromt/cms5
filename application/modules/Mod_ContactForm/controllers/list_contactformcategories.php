...
class list_contactformcategories extends TCRUDListController
{
    ...
    public function execute()
    {
        ...
        $arrTableColumnsShow = array(
            array('', TContactFormCategories::FIELD_CATEGORYNAME, transm(CMS_CURRENTMODULE, 'list_column_'.TContactFormCategories::FIELD_CATEGORYNAME, 'Category')),
            array('', TContactFormCategories::FIELD_COLORBACKGROUND, transm(CMS_CURRENTMODULE, 'list_column_'.TContactFormCategories::FIELD_COLORBACKGROUND, 'Color')),
    ...
    {
        return 'detailsave_contactformcategories';
    }
    ...
    {
        //global CMS_CURRENTMODULE;
        return transm(CMS_CURRENTMODULE, 'tab_title_contactformcategories', 'Contact form categories');
    }
