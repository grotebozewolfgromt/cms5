...
use dr\classes\TConfigFileFramework;
...
class settings_global extends TCRUDDetailSaveController
{
    ...
    private $objConfigFile = null;//TConfigFileFramework


    public function __construct()
    {
        $this->objConfigFile = new TConfigFileFramework();
   ...
   /**
    ...
    {
        $this->objConfigFile->loadFile(APP_PATH_CMS_CONFIGFILE_FRAMEWORK);
    }
    ...
    {
        return $this->objConfigFile->saveFile(APP_PATH_CMS_CONFIGFILE_FRAMEWORK);
    }
