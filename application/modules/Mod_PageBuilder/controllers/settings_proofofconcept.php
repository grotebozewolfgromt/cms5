...
class settings extends TCRUDConfigFileController
{
    ...
    const FIELD_NAME = 'PAGEBUILDER_NAME';
    const FIELD_ISDEFAULT = 'PAGEBUILDER_ISDEFAULT';
    ...
    {
        return Mod_PageBuilder::PERM_CAT_SETTINGS;
    }
   ...
   /**
    ...
    public function getTitle()
    {
        ...
        return transm(APP_ADMIN_CURRENTMODULE, 'pagetitle_detailsave_settings', 'Settings page builder');   
    }
    ...
    {
        return new TConfigFilePagebuilder();
    }
