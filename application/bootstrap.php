...
use dr\classes\patterns\TConfigFile;
    ...
    //================== LOADING CONFIG FILE =================== 
        ...
        define('APP_PATH_CMS_CONFIGFILE_FRAMEWORK', APP_PATH_CMS_CONFIGS.DIRECTORY_SEPARATOR.'application_'.$_SERVER['SERVER_NAME'].'.php');
        ...
        //config framework
        include_once(APP_PATH_CMS_CONFIGFILE_FRAMEWORK);   
        if (!defined('APP_DEBUGMODE')) //check 1 value to see if config is loaded properly
        {
            ...
            error_log('error loading config file: '.APP_PATH_CMS_CONFIGFILE_FRAMEWORK);
            die();
        }
